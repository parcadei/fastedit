...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "via tldr importers. Pass dry_run=True for a preview. Python and "
        "TypeScript named imports handled; wildcard/barrel re-exports are "
        "flagged for manual review. Instant, no model.\n"
